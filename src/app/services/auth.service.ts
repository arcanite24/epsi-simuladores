...
export class AuthService {
  ...
  get isLight2020() { return this.loggedIn && this.user[Roles.isLight2020]; }
  get isPremium2020() { return this.loggedIn && this.user[Roles.isPremium2020]; }

  get isMedicinaInterna2020() { return this.loggedIn && this.user[Roles.isMedicinaInterna2020]; }
  get isPediatria2020() { return this.loggedIn && this.user[Roles.isPediatria2020]; }
  get isGineco2020() { return this.loggedIn && this.user[Roles.isGineco2020]; }
  get isCirugia2020() { return this.loggedIn && this.user[Roles.isCirugia2020]; }
  get isUrgencias2020() { return this.loggedIn && this.user[Roles.isUrgencias2020]; }
