...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pago_detail__ = __webpack_require__(747);
...
var FileUploadComponent = /** @class */ (function () {
    ...
    FileUploadComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["Component"])({
            selector: 'file-upload',template:/*ion-inline-start:"/Users/elzombieisra/Documents/development/zamna-pagos/src/components/file-upload/file-upload.html"*/'<div class="flex-col">\n  <input type="file" hidden #fileInput (change)="onImageSelected(fileInput.files)">\n  <label>\n    <button ion-button [disabled]="loader" (click)="fileInput.click()" [clear]="clear">{{text}}</button>\n  </label>\n  <div class="flex-col">\n    <img [src]="resImage" *ngIf="resImage && showPreview" style="width:40%" class="mtb-1">\n  </div>\n</div>\n'/*ion-inline-end:"/Users/elzombieisra/Documents/development/zamna-pagos/src/components/file-upload/file-upload.html"*/
        }),
