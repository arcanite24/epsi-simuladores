...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__team_detail__ = __webpack_require__(753);
...
var TeamDetailPage = /** @class */ (function () {
    ...
    TeamDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-team-detail',template:/*ion-inline-start:"/Users/elzombieisra/Documents/development/zamna-pagos/src/pages/team-detail/team-detail.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n    <ion-title>Detalle del equipo</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content class="bg-eee">\n\n  <ng-template #loading>\n    <div class="flex-loader">\n      <ion-spinner></ion-spinner>\n    </div>\n  </ng-template>\n\n  <div class="team-container" *ngIf="team$ | async as team else loading">\n\n    <ion-list>\n      <ion-list-header>Miembros</ion-list-header>\n      <ion-item *ngFor="let user of team.members">\n        <h2>{{user.name}} {{user.lastName}}</h2>\n        <p>Roles: {{user.roles}}</p>\n      </ion-item>\n    </ion-list>\n\n  </div>\n\n</ion-content>\n'/*ion-inline-end:"/Users/elzombieisra/Documents/development/zamna-pagos/src/pages/team-detail/team-detail.html"*/,
        }),
