...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__admin__ = __webpack_require__(735);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash__ = __webpack_require__(736);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__app_app_models__ = __webpack_require__(456);
...
var AdminPage = /** @class */ (function () {
    function AdminPage(navCtrl, navParams, back, load, toast, modal, auth, afs) {
    ...
    Object.defineProperty(AdminPage.prototype, "totalPagadoFilter", {
        get: function () {
            return this.controles.length > 0 ? this.controles.map(function (p) { return p.price - parseFloat(p.amountLeft.toString()); }).reduce(function (a, b) { return a + b; }) : 0;
        },
        enumerable: true,
        configurable: true
    });
    ...
    AdminPage.prototype.filter = function (mode, method) {
        switch (mode) {
            case 'limpiar':
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(45), __webpack_require__(460)(module)))
