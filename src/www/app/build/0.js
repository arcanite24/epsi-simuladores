...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__resultados_examen__ = __webpack_require__(1238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__swimlane_ngx_charts__ = __webpack_require__(598);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_components_module__ = __webpack_require__(1191);
...
let ResultadosExamenPageModule = class ResultadosExamenPageModule {
};
...
let ResultadosExamenPage = class ResultadosExamenPage {
    constructor(navCtrl, navParams, viewCtrl, data) {
        this.navCtrl = navCtrl;
    ...
    loadResultados() {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this.data.getDoc(__WEBPACK_IMPORTED_MODULE_4__app_app_models__["a" /* Collections */].EXAM_RESULT, this.id);
            let r = Object.assign({}, result, { preguntas: Object.values(result.questions) });
            console.log(r);
            this.resultados = [r];
            this.exam = yield this.data.getDocAlt(__WEBPACK_IMPORTED_MODULE_4__app_app_models__["a" /* Collections */].EXAM, result.exam);
        });
    }
    formatDate(date) {
