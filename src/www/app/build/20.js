...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__post_comments__ = __webpack_require__(813);
...
var PostCommentsPageModule = /** @class */ (function () {
    ...
    PostCommentsPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__post_comments__["a" /* PostCommentsPage */]),
            ],
        })
...
var PostCommentsPage = /** @class */ (function () {
    ...
    PostCommentsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-post-comments',template:/*ion-inline-start:"C:\Users\Brandon G. Neri\code\zamnademy-app-v1\src\pages\post-comments\post-comments.html"*/'<ion-header>\n\n\n\n  <ion-navbar color="primary">\n\n    <ion-title>Comentarios</ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button icon-only (click)="viewCtrl.dismiss()">\n\n        <ion-icon name="close"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content class="bg-eee">\n\n\n\n  <ion-list>\n\n    <ion-item *ngIf="!comments || comments.length <= 0">No hay comentarios en ésta publicación...</ion-item>\n\n    <ion-item *ngFor="let c of comments" text-wrap>\n\n      <ion-avatar item-start>\n\n        <img [src]="c.user.photoURL ? c.user.photoURL : \'assets/imgs/profile.jpg\'">\n\n      </ion-avatar>\n\n      <h2>{{c.user.displayName}}</h2>\n\n      <p>{{c.text}}</p>\n\n    </ion-item>\n\n  </ion-list>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\Brandon G. Neri\code\zamnademy-app-v1\src\pages\post-comments\post-comments.html"*/,
        }),
