...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__simuladores__ = __webpack_require__(1214);
...
var SimuladoresPage = /** @class */ (function () {
    function SimuladoresPage(navCtrl, navParams, afs, auth) {
    ...
    SimuladoresPage.prototype.ionViewDidLoad = function () {
        ...
        this.auth.user$.subscribe(function (user) {
            if (user && !_this.completed)
                _this.completed = user.completedExams || [];
        });
