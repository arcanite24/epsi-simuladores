...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__bloque_alt__ = __webpack_require__(1205);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_lodash__ = __webpack_require__(591);
...
let BloqueAltPage = class BloqueAltPage {
    ...
    loadChildren(id, user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.children = children.filter(c => user.isPremium2019 ? true : c.liberadoInPrograma);
