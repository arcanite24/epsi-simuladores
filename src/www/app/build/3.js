...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__materia__ = __webpack_require__(1221);
...
let MateriaPage = class MateriaPage {
    ...
    loadContent(id) {
        return __awaiter(this, void 0, void 0, function* () {
            let materia = yield this.data.getDoc(__WEBPACK_IMPORTED_MODULE_2__app_app_models__["a" /* Collections */].CONTENT, id);
            materia.children = yield this.data.getCollectionQuery(__WEBPACK_IMPORTED_MODULE_2__app_app_models__["a" /* Collections */].CONTENT, ref => ref
                .where('parent_id', '==', materia.id));
            materia.children = materia.children.map(m => (Object.assign({}, m, { children: [] })));
            // Load temas
            for (let bloque of materia.children) {
                bloque.children = yield this.data.getCollectionQuery(__WEBPACK_IMPORTED_MODULE_2__app_app_models__["a" /* Collections */].CONTENT, ref => ref
                    .where('parent_id', '==', bloque.id));
                // Load subtemas
                for (let tema of bloque.children) {
                    tema.children = yield this.data.getCollectionQuery(__WEBPACK_IMPORTED_MODULE_2__app_app_models__["a" /* Collections */].CONTENT, ref => ref
