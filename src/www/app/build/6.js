...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__examen_detail__ = __webpack_require__(1225);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_countdown__ = __webpack_require__(1166);
        ...
        this.exam$ = this.afs.collection(__WEBPACK_IMPORTED_MODULE_3__app_app_models__["a" /* Collections */].EXAM).doc(this.id)
            ...
            if (data.duration) {
                const alert = this.alert.create({
                    ...
                    buttons: [
                        { text: 'Sí', handler: () => this.handleSetTimer(data.duration * 60 * 1000) },
                        { text: 'No', role: 'cancel' }
                    ]
                });
                alert.present();
