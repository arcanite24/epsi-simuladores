...
$(document).ready(function($) {
  ...
  $('#contact-form').submit(function(e) {
    ...
    db.collection('contact').add({
      ...
      swal('¡Listo!', 'En breve nos pondremos en contacto contigo.');
      $('#contact-email').val('')
    })
  ...
  if ($('.nav').length) {
    ...
    // Loop all menu items
    $(
      '.nav .navbar-item, li.has-children ul li a.is-submenu, a.footer-nav-link'
    ).each(function() {
      // select href
  ...
  //Website sidebar
  $('.navigation-menu > li.has-children a.parent-link').on('click', function(
    i
  ) {
    i.preventDefault();
    if (
